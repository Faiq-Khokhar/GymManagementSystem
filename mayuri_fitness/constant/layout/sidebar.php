     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Coach</span></a>
                     <ul aria-expanded="false" class="collapse">
                         <li><a href="new_coach.php">Add Coach</a></li>
                         <li><a href="view_coach.php">Manage Coach</a></li>
                 ...
                 <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-file-text-o"></i><span class="hide-menu">Plan</a>
                     <ul aria-expanded="false" class="collapse">
                         <a href="new_plan.php">New Plan</a>
                 </li>
