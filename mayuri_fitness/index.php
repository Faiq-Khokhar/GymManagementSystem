...
<div id="main-wrapper">
 ...
 background-color: #cccccc; width:100%; height:100vh">
      <div class="row">
        <div class="col-lg-3">
          <div class="login-content card">
            <center><img src="./assets/uploadImage/Logo/gymStudio2.png" style="width:100%;"></center><br><!-- <h4>Login</h4> -->
            <div class="login-form">
              ...
              <form method="POST">
                ...
                <center><span>Redirect to Homepage?<a href="../index.html"> <br>Click Here</a></span></center>
